...
- Capture *why*, not *what* — the diff already shows what. Record the decision, the alternatives considered, and the failed approaches that taught you the right one.
