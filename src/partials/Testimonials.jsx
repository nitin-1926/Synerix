      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-4xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Experts from top product based companies</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">Monkster is a team of experts from top Product based companies, who share your passion for products, have been solving complex problems and helping companies build products.</p>
          </div>
