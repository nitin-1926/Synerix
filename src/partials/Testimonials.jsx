...
// import TestimonialImage from '../images/utkarsh.png';
// import Jupiter from '../images/image.png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-4xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">Unlock your small manufacturing enterprise's potential with Pinata's seasoned experts, each boasting over 25 years of invaluable experience in MSME consulting services. Today, leverage our tailored guidance and expertise to conquer challenges and open doors to unparalleled opportunities. Our professionals, with deep industry insight, specialize in financial management, operational efficiency, strategic planning, marketing, and technology adoption. Let us be your trusted guide, propelling your success story forward and building a resilient future for your Indian small manufacturing enterprise. With Pinata's experts by your side, every step forward is a stride toward unlocking your business's immense potential. Choose confidence, choose Pinata.</p>
          </div>
            ...
            {/* <div className="relative flex items-start border-2 border-gray-200 rounded bg-white"> */}
              ...
              {/* <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  <svg className="absolute top-0 right-0 -mt-3 -mr-8 w-16 h-16 fill-current text-orange-500" viewBox="0 0 64 64" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-gray-600">
                  <span>Program Manager</span> <a className="text-orange-600 hover:underline" href="https://acciojob.com/" target='_blank'>@AccioJob</a>
                </div>
              </div> */}
