      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">How Monkster fixes your workflow?</h2>
            <p className="text-xl text-gray-600">At Monkster, your students won’t just learn how to ace mock interviews – you’ll get a team of experienced and talented mentors to coach them, as they go through their course. We'll also provide you with mock interviewers who are available at all times to assist in any way they can.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">First meet to understand the current workflow and your requirements.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Bringing new plan to fix and improve the workflow.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Team deployment</h4>
              <p className="text-gray-600 text-center">Dedicated team of experts for throughout the duration.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Curriculum design</h4>
              <p className="text-gray-600 text-center">Designing curriculum on basis of batch goals and objectives.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Kickoff Session</h4>
              <p className="text-gray-600 text-center">Experts starting the sessions, along with detailed feedback for each session.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Monthly Analytics and several important metrics to track the progress efficiently.</p>
            </div>
