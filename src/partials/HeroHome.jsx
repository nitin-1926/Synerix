...
import HeroImage from '../images/IllustHero.png';
...
'-webkit-text-fill-color': 'transparent',
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Get expert advice to grow your business. Let's achieve success together.</p>
