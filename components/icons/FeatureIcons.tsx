...
export const BusinessPlanningIcon: React.FC = () => (
	<g strokeWidth="2">
		<path
...
export const FinancialManagementIcon: React.FC = () => (
...
export const MarketingIcon: React.FC = () => (
	<g transform="translate(22.857 19.429)" strokeWidth="2">
		...
		<circle className="stroke-current text-gray-800" strokeLinecap="square" cx="12.571" cy="12.571" r="3.429" />
	</g>
);
...
export const TechIcon: React.FC = () => (
	<g strokeLinecap="square" strokeWidth="2">
		...
		<path className="stroke-current text-gray-800" d="M38.858 26.993l6.397 1.73-4.473 16.549-13.24-3.58" />
	</g>
);

export const SupplyChainIcon: React.FC = () => (
	<g strokeWidth="2">
		<path
			className="stroke-current text-white"
